...
module QA
  RSpec.describe 'Monitor' do
    describe(
      ...
      let(:node_sdk_app) { Service::DockerRun::ProductAnalytics::NodeSdkApp.new(sdk_host) }
      ...
      it 'displays events from node sdk',
        testcase: 'https://gitlab.com/gitlab-org/gitlab/-/quality/test_cases/464761' do
        sdk_app_id = 0
        ...
        node_sdk_app.pull
        node_sdk_app.register!(sdk_app_id)
        node_sdk_app.trigger_event
