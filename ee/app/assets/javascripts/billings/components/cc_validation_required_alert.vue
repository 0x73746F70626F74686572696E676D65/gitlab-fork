...
const i18n = {
  successAlert: {
    ...
    text: s__(
      "Billings|You'll now be able to take advantage of free compute minutes on instance runners.",
    ),
  },
  dangerAlert: {
    title: s__('Billings|User validation required'),
    text: s__(`Billings|To use free compute minutes on instance runners, you'll need to validate your account with a credit card. If you prefer not to provide one, you can run pipelines by bringing your own runners and disabling instance runners for your project.
