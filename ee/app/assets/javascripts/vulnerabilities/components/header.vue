...
export const CREATE_MR_AI_ACTION = {
  ...
  tagline: s__('ciReport|Automatically opens a merge request with a solution generated by AI'),
  ...
  computed: {
    actionButtons() {
      ...
      if (this.vulnerability.reportType === REPORT_TYPE_SAST) {
        if (this.glFeatures.resolveVulnerabilityAiGateway) {
          buttons.push(CREATE_MR_AI_ACTION);
        } else if (this.glFeatures.resolveVulnerability) {
