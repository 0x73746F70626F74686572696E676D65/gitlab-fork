...
export const mockQueryBuilderValues = {
  availableMeasures: mockMetaData.cubes.at(0).measures,
  availableDimensions: mockMetaData.cubes.at(0).dimensions,
  availableTimeDimensions: [
    {
      name: 'ReturningUsers.first_timestamp',
      title: 'Returning Users First Timestamp',
      type: 'time',
      shortTitle: 'First Timestamp',
      suggestFilterValues: true,
      isVisible: true,
      public: true,
      primaryKey: false,
